...
<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
        ...
        @else
            <!-- ========== OTHER PAGES LAYOUT ========== -->
            <!-- Logo kecil di kiri (untuk halaman lain) -->
            <a href="{{ route('home') }}" class="logo d-flex align-items-center">
                <img src="{{ asset('assets/assets/logojayatama.png') }}" alt="Jayatama Logo" style="height: 60px;">
            </a>

            <!-- Semua menu di kanan (untuk halaman lain) -->
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="{{ route('home') }}" class="{{ $currentRoute == 'home' ? 'active' : '' }}">Beranda</a></li>
                    <li><a href="{{ route('about') }}" class="{{ $currentRoute == 'about' ? 'active' : '' }}">Tentang Kami</a></li>
